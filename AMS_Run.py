    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'E:/Face-Recognition-Attendance-System/Allcsv/' + DB_table_name + '.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"E:\Face-Recognition-Attendance-System\Allcsv\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'E:/Face-Recognition-Attendance-System/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"E:\Face-Recognition-Attendance-System\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'Bishal':
            if password == 'Bishal123':
                ...
                cs = 'E:/Face-Recognition-Attendance-System/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
